...
@Entity @Table(name="ehs_corrective_action_record") public class CorrectiveActionRecord extends BaseEntity {
    ...
    protected CorrectiveActionRecord(){} public CorrectiveActionRecord(SafetyInspection safetyInspection,String operationName,int goodQty,int defectQty,String operatorName,String remark){this.safetyInspection=safetyInspection;this.operationName=operationName;this.goodQty=goodQty;this.defectQty=defectQty;this.operatorName=operatorName;this.reportedAt=LocalDateTime.now();this.remark=remark;}
    public SafetyInspection getSafetyInspection(){return safetyInspection;} public String getOperationName(){return operationName;} public int getGoodQty(){return goodQty;} public int getDefectQty(){return defectQty;} public String getOperatorName(){return operatorName;} public LocalDateTime getReportedAt(){return reportedAt;}
}
