...
@Entity @Table(name="ehs_safety_area") public class SafetyArea extends BaseEntity {
    ...
    protected SafetyArea(){} public SafetyArea(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
