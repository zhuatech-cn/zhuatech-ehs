...
@Entity @Table(name="ehs_hazard_control") public class HazardControl extends BaseEntity {
     ...
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    protected HazardControl(){} /**
                                 * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                                 */
public HazardControl(String code,String name,SafetyArea safetyArea,Status status,int oee){this.code=code;this.name=name;this.safetyArea=safetyArea;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
